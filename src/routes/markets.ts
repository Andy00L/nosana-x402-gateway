...
// fails, markets still list with availability "unknown". The whole surface
// fans out to the markets API and the chain, so it sits behind the
...
export const createMarketsRouter = (
  ...
  marketsRouter.use("*", rateLimitMiddleware);
